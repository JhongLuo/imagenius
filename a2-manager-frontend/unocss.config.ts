...
export default defineConfig({
  shortcuts: [
    ...
    ['my-input-style', 'text-sm font-medium rounded-md my-text-color-primary my-bg-primary my-border'],
    ['my-text-input-style', 'w-full px-4 py-2 my-input-style'],
    ['my-title-style', 'mb-5 text-xl font-extrabold my-text-color-primary select-none'],
    ['my-label-style', 'mb-2 text-sm font-medium my-text-color-primary'],
