  ...
  <div class="container-lg my-5 px-0 mb-3">
    <div class="container">
      <div class="row row-cols-2 g-5">
        <div class="col">
          <canvas :id="idChartNumsItems" />
        </div>
        <div class="col">
          <canvas :id="idChartUsagesSize" />
        </div>
        <div class="col">
          <canvas :id="idChartUsagesPercent" />
        </div>
        <div class="col">
          <canvas :id="idChartNumsRequests" />
        </div>
        <div class="col">
          <canvas :id="idChartHitRates" />
        </div>
        <div class="col">
          <canvas :id="idChartMissRates" />
        </div>
      </div>
    </div>
  </div>
