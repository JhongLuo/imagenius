...
export default defineConfig({
  shortcuts: [
    ...
    // components
    ['my-input', 'w-full px-4 py-2 text-sm font-medium rounded-md my-text-color-primary my-bg-primary my-border pla disabled:text-op-15 disabled:placeholder-op-15'],
